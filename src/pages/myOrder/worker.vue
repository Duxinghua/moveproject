	...
	<div class='worked'>
		...
		<div class='calling' v-if="orderDetail.orderStatus!='WAIT_REC' && orderDetail.orderStatus!='NOPAY' && orderDetail.orderStatus!='NOPAY2' && orderDetail.orderStatus!='CANCEL_APPLY'">
			<div>
				...
				<div class='rates' v-if="orderDetail.serverType=='HIRE_WORKER'">
					<div>
		...
		<div class="address">
			<div class="left_wrap">
				<div class="start">
					<!-- <image src='../../assets/img/dingwei.png' class='dingwei'></image> -->
				<!-- 	<div class='people'>
...
<script>
	...
	export default {
		...
		methods: {
			gocost() {
				calcHireWorkerDet(this.orderDetail).then(res => {
					if(res.code==200){
						uni.navigateTo({
