<template>
    <div class="goods-details">
        <div class="goods-swiper">
            <van-swipe :autoplay="10000" @change="onSwipeChange">
                <van-swipe-item
        ...
        <div class="goods-content">
            <div class="goods-tab">
                ...
                <div :class="['tab-item' ,{'active' : tabIndex == 1}]" @click="onTabChange(1)">
                    商品评价
                </div>
            </div>
            ...
            <div class="goods-comments" v-if="tabIndex == 1">
                <van-list
                    v-model="loading"
                    :finished="finished"
                    finished-text="没有更多了"
                ...
                <div class="comments-no" v-if="comments.length == 0">暂无评论</div>
            </div>
        </div>
